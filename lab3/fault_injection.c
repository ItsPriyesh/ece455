...
#define PROBABILITY_OF_RANDOM_FAULT 0.25
    /* You may adjust this constant for specific tests or to 
       assert some different behaviour you may require.
       However, please take into account that the evaluation 
       may be done with this or any other value that we may 
